...
function About() {
  return (
    <div
      id="about"
      className="px-1 sm:px-0 md:px-4 pt-16 flex flex-col items-center justify-start bg-white font-dm overflow-x-hidden"
    >
      <Aboutheader />
      <br />

      <div className="w-[90vw] max-w-2xl bg-white/80 backdrop-blur-md border border-black rounded-md shadow-sm overflow-hidden font-mono text-sm text-left mb-6">
  ...
  strategy: "analytical"
      ...
      <div className="w-[90vw] max-w-2xl px-4 py-6 sm:px-6 text-left text-black text-[16px] leading-normal bg-white border border-gray-300 rounded-lg relative">
        <p className="mb-4">
